...
(setq org-directory "~/Dropbox (University of Michigan)/org")
...
(use-package org-download
  ...
  (org-download-screenshot-method "screenshot.sh %s")
  :bind
...
(setq easy-hugo-basedir "~/Projects/SideProjects/personal-website/upcoming/personal-hugo-v1/")


;; let tab do it's thing
(map! :map cdlatex-mode-map :i "TAB" #'cdlatex-tab)
;; main is the main file for all latex files
(setq-default TeX-master "main")

;; disable company in favor of cdlatex bc it's faster
